...
3. Install the dependencies using the latest version of pip_:
   ...
   .. code-block:: bash
      ...
      pip install --require-hashes -c requirements/constraints.txt -r requirements/dev.txt
      pip install --require-hashes -c requirements/constraints.txt -r requirements/test.txt
